...
class BLEItemAdapter extends ArrayAdapter {
    public BLEItemAdapter(Context context, ArrayList<BluetoothDevice> bleDevices) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (currItemView == null) {
            currItemView = LayoutInflater.from(getContext()).inflate(R.layout.item_bluetooth_device, parent, false);
        }
